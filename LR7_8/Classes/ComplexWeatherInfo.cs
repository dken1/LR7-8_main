...
namespace LR7_8.Classes
{
    public class ComplexWeatherInfo
    {
        ...
        {
            get { return _weather; }
            set { _weather = value ?? throw new ArgumentNullException(nameof(_weather)); }
        }
        public double Temperature { get; set; }
        public double Humidity { get; set; }
        public ComplexWeatherInfo() { }
        public ComplexWeatherInfo(string time, Type_of_weather weather, double temperature, double humidity)
        {
            Time = time;
            Weather = weather;
